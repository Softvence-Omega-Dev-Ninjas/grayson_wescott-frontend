...
title: "Elite Squat Builder",
  ...
  return (
    <div className="bg-black py-8">
        ...
        <SectionHeader title="Elite Protocol Modules"
        description="Systems to erase limits, rebuild movement & install strength."/>
        ...
        <div className="container mx-auto space-y-4 sm:space-y-6 px-2">
          ...
          <Button className="bg-[#B9BDC6] uppercase text-black px-6 py-4 rounded-none hover:bg-[#a5a8ae] cursor-pointer">EXPLORE THE COLLECTION</Button>
        </div>
        </div>
