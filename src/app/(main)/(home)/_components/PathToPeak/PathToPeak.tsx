    ...
    <div className="bg-black py-8">
      <Container>
        <div className="space-y-5">
          {" "}
          <SectionHeader title={"Path To Peak"} />
          ...
          <div className="flex items-center justify-center mt-14">
            <Button className="bg-[#B9BDC6] uppercase text-black px-6 py-4 text-xl font-medium rounded-none hover:bg-[#a5a8ae] cursor-pointer">
              Start Your Build
            </Button>
          </div>
        </div>
