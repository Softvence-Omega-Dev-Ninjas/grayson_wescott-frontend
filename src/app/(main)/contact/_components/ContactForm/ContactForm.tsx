  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 py-8 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-8">
            <h1 className="text-3xl lg:text-4xl font-light mb-8">
              Get in touch
            </h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Max file size: PDF, Document about 10 pages
                    </p>
                    <input
                      type="file"
                      className="hidden"
                    ...
                    <label
                      htmlFor="file-upload"
                      className="cursor-pointer inline-block w-full h-full"
                    />
                  </div>
          ...
          <div className="space-y-8">
            <div className="bg-primary-200 p-6 lg:p-8">
              ...
              <p className="text-gray-300 mb-8">
                250B, West Site House Main Town, New York
              </p>
      ...
      <div className="my-28 space-y-10">
        <CTA
          title="READY TO BUILD THE UNBREAKABLE?"
          img={contactImg.src}
          btn1="START YOUR BUILD"
        />
      </div>
    </div>
  );
