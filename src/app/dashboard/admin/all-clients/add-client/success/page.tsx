    ...
    <div className="flex items-center justify-center p-4 text-white">
      <div className="max-w-7xl w-full">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-semibold text-center mt-6">Clients Added Successfully!</h1>
          <p className="text-gray-300 text-center mt-2">All onboarding processes have been initiated automatically.</p>
        </div>
          ...
          <div className="flex items-center justify-between p-4 bg-secondary">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Profile information stored successfully</p>
              </div>
            </div>
            <Image src={tickIcon} width={26} height={26} alt="Upload Icon" className="bg-secondary rounded-full w-4 h-4" />
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-secondary">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Clients added to membership platform</p>
              </div>
            </div>
            <Image src={tickIcon} width={26} height={26} alt="Upload Icon" className="bg-secondary rounded-full w-4 h-4" />
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-secondary">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Onboarding email sequence initiated</p>
              </div>
            </div>
            <Image src={tickIcon} width={26} height={26} alt="Upload Icon" className="bg-secondary rounded-full w-4 h-4" />
          </div>
        ...
        <div className="border border-[#F4F5F7] p-6  mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="bg-[#B9BDC6] text-xs font-bold px-2 py-1 uppercase text-black">Active</span>
            </div>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <Link href={"/dashboard/admin/all-clients/add-client"} className="flex-1 w-full">
