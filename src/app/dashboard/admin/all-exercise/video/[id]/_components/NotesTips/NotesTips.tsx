  ...
  return (
    <div className="space-y-4 mt-6">
      ...
      <div className="space-y-3">
        {notes.map((note) => (
          <div key={note.id} className="bg-primary-200 border border-secondary  p-4">
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-white font-medium text-sm">{note.author}</span>
                  {note.role && <span className="text-blue-400 text-xs">{note.role}</span>}
                </div>
