...
export function WorkoutCard({ excercise }: { excercise: any }) {
  return (
    <div className="bg-primary-200 border border-secondary p-2 overflow-hidden group ">
      ...
      <div className="p-1">
        ...
        <div className="flex gap-2 pt-2">
          <Link
            href={`/dashboard/admin/all-exercise/view-details/${excercise.id}`}
          ...
          <Link
            href={`/dashboard/admin/all-exercise/video/${excercise.id}`}
            className="flex-1 w-full"
          >
            <Button
              size="sm"
