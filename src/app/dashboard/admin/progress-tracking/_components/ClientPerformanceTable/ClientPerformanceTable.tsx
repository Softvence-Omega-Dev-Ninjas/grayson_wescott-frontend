        ...
        <table className="w-full min-w-[800px] border-collapse">
          <thead>
            <tr className="border-b border-gray-800 bg-secondary text-white">
              ...
              <th className="text-left py-3 px-5  font-medium">Workouts Completed</th>
          ...
          <tbody>
            {clients.map((client, index) => (
              <tr key={index} className="border-b border-gray-800/50">
                ...
                <td className="py-4 px-5 text-gray-300">{client.currentWeek}</td>
                <td className="py-4 px-5">
                  <span className="bg-green-900/30 text-green-400 border border-green-800 px-2 py-1 rounded text-sm">{client.completion}%</span>
                </td>
                <td className="py-4 px-5">
                  <span className="bg-blue-900/30 text-blue-400 border border-blue-800 px-2 py-1 rounded text-sm">{client.compliance}%</span>
                </td>
                <td className="py-4 px-5 text-gray-300">{client.workoutsCompleted}</td>
