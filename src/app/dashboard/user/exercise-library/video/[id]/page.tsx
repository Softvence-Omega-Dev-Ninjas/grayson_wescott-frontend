...
const notesTips = [
  {
    ...
    role: "Trainer",
    content: "Remember to keep your knees tracking over your toes throughout the movement. This prevents knee valgus and reduces injury risk.",
  },
  {
    id: "2",
    author: "Sarah J",
    avatar: "/placeholder.svg?height=32&width=32",
    content: "I found that the step-by-step breakdown really helped me understand the proper form. My squats have improved significantly.",
  },
];
    ...
    <div className="mb-20">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          {/* Video Player */}
          <VideoPlayer src={sampleWorkout.videoSrc} poster={sampleWorkout.poster} />
          ...
          <div className="space-y-2 mb-5">
            ...
            <div className="flex items-center justify-start flex-wrap gap-x-6 gap-y-2">
              ...
              <div className="flex items-center gap-1">
                <Image src={watchIcon} alt="Tags" width={12} height={12} className="shrink-0" />
                <span className="font-medium text-sm text-white mt-0.5">{"6.3k Views"}</span>
              </div>
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="mt-4 space-y-2">
              <p className="text-gray-300">
                <strong>Benefits:</strong> Builds lower body strength, glute, hamstring, and calf muscle development, improves posture potential for
                daily activities and athletic performance.
              </p>
              <p className="text-gray-300">
                <strong>Common Mistakes to Avoid:</strong> Knee valgus (knees caving in), insufficient depth, and improper bar positioning. Focus on
                maintaining neutral spine throughout the exercise.
              </p>
            </div>
          </div>
