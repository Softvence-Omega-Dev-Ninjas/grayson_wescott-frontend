...
const ViewUserExcerciseDetailsPage = async ({
  params,
}: {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 items-start gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="relative">
            ...
            />
            <Link
              href={`/dashboard/user/exercise-library/video/${excerciseDetails?.data?.id}`}
...
export default ViewUserExcerciseDetailsPage;
